...
export const createReply = async ({ reviewId, content, parentCommentId }: { reviewId: string, content: string, parentCommentId: string }) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/reviews/${reviewId}/comments`, {
    method: 'POST',
    credentials: 'include',
    headers: {
...
export const likeComment = async (commentId: string) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/reviews/comments/${commentId}/like`, {
    method: 'POST',
    credentials: 'include',
  });
...
export const unlikeComment = async (commentId: string) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/reviews/comments/${commentId}/unlike`, {
    method: 'POST',
    credentials: 'include',
  });
